// from https://github.com/belyalov/stm32-hal-libraries/
...
EXPORT float si7021_measure_humidity(I2C_HandleTypeDef *hi2c);
...
// e.g. `+23.12C` -> `2312`
// In case of error returns `SI7021_MEASURE_FAILED`
EXPORT float si7021_measure_temperature(I2C_HandleTypeDef *hi2c);
...
// e.g. `+23.12C` -> `2312`
// In case of error returns `SI7021_MEASURE_FAILED`
EXPORT float si7021_read_previous_temperature(I2C_HandleTypeDef *hi2c);
